...
public class MaiCtrl implements Initializable {
                ...
                for (Tache t : niv) {
                    ...
                    for (Tache pred : t.getPreds()) {
                        ...
                        if (cPath.contains(pred) && cPath.contains(t)) {
                            ...
                            System.out.println(" p  "+pred.getId());
                            System.out.println(" j"+t.getId());
                            l.toFront();
